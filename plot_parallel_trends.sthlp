...
{pstd}
{cmd:plot_parallel_trends} folder(string) silos(string) freq(string) [{it:save_csv(string)} {it:covariates(string)} {it:save_image(string)} {it:omit_silos(string)}]{p_end}

{title:Examples}

{phang2}{cmd:plot_parallel_trends}
