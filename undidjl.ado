...
program define checkundidversion, rclass
	...
	jl: SF_display("Check https://github.com/ebjamieson97/Undid.jl/blob/main/Project.toml for latest version number and call <<jl: using Pkg; Pkg.add(url=\"https://github.com/ebjamieson97/Undid.jl\")>>.")
